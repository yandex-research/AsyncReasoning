...
def main():
    ...
    def _solve_task_and_save(idx: int):
        ...
        instruction = str(dataset['multi_step_reasoning'][idx]['context_transcript'])
        answer = str(dataset['multi_step_reasoning'][idx]['answer']['text'][0])
